...
class DatasetShareForm(BaseModel):
    ...
    DatasetShareForm
    """ # noqa: E501
    marketplace_url: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="marketplaceUrl")
    __properties: ClassVar[List[str]] = ["marketplaceUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "marketplaceUrl": obj.get("marketplaceUrl")
        })
        return _obj
