...
class Distribution(BaseModel):
    ...
    Distribution
    """ # noqa: E501
    bytesize: Optional[StrictInt]
    mimetype: StrictStr
    checksum: StrictStr
    access_service: List[DataService] = Field(alias="accessService")
    __properties: ClassVar[List[str]] = ["bytesize", "mimetype", "checksum", "accessService"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if bytesize (nullable) is None
        # and model_fields_set contains the field
        if self.bytesize is None and "bytesize" in self.model_fields_set:
            _dict['bytesize'] = None
