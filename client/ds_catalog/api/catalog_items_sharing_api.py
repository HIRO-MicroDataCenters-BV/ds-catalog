...
class CatalogItemsSharingApi:
    ...
    @validate_call
    def share_catalog_item(
        self,
        id: StrictStr,
        catalog_item_share_form: CatalogItemShareForm,
        ...
        :param id: (required)
        :type id: str
        :param catalog_item_share_form: (required)
        :type catalog_item_share_form: CatalogItemShareForm
        ...
        _param = self._share_catalog_item_serialize(
            id=id,
            catalog_item_share_form=catalog_item_share_form,
    ...
    @validate_call
    def share_catalog_item_with_http_info(
        self,
        id: StrictStr,
        catalog_item_share_form: CatalogItemShareForm,
        _request_timeout: Union[
    ...
    @validate_call
    def share_catalog_item_without_preload_content(
        self,
        id: StrictStr,
        catalog_item_share_form: CatalogItemShareForm,
        _request_timeout: Union[
    ...
    def _share_catalog_item_serialize(
        self,
        id,
        catalog_item_share_form,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if catalog_item_share_form is not None:
            _body_params = catalog_item_share_form
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/catalog-items/{id}/share/',
