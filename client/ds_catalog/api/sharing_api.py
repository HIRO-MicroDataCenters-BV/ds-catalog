...
class SharingApi:
    ...
    def share_dataset(
        self,
        id: StrictStr,
        dataset_share_form: DatasetShareForm,
        ...
        :param id: (required)
        :type id: str
        :param dataset_share_form: (required)
        :type dataset_share_form: DatasetShareForm
        ...
        _param = self._share_dataset_serialize(
            id=id,
            dataset_share_form=dataset_share_form,
    ...
    def _share_dataset_serialize(
        ...
        if dataset_share_form is not None:
            _body_params = dataset_share_form
