...
class ImportingApi:
    ...
    def import_dataset(
        self,
        dataset_import_form: DatasetImportForm,
        ...
        :param dataset_import_form: (required)
        :type dataset_import_form: DatasetImportForm
        ...
        _param = self._import_dataset_serialize(
            dataset_import_form=dataset_import_form,
    ...
    def _import_dataset_serialize(
        ...
        if dataset_import_form is not None:
            _body_params = dataset_import_form
