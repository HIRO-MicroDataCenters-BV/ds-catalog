...
class TestCreatorId(unittest.TestCase):
    """CreatorId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatorId:
        """Test CreatorId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatorId`
        """
        model = CreatorId()
        if include_optional:
            return CreatorId(
