...
class TestSourceInterface(unittest.TestCase):
    """SourceInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceInterface:
        """Test SourceInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceInterface`
        """
