...
class TestDataProductForm(unittest.TestCase):
    """DataProductForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataProductForm:
        """Test DataProductForm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataProductForm`
        """
        model = DataProductForm()
        if include_optional:
            return DataProductForm(
                id = '',
                name = '',
                size = None,
                mimetype = '',
