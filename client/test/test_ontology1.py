...
class TestOntology1(unittest.TestCase):
    """Ontology1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ontology1:
        """Test Ontology1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ontology1`
        """
        model = Ontology1()
        if include_optional:
            return Ontology1(
